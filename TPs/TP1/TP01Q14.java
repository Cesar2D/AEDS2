...
public class TP01Q14 {
    static String expressao(String s, int x) {
        s = s.replace(" ", "");
        ...
        return expressaoRecursiva(s, x, a, b, c);
    }

    static String expressaoRecursiva(String s, int x, String a, String b, String c) {
        if (x > 1) {
            s = s.replace("A", a);
            s = s.replace("B", b);
            s = s.replace("C", c);
            ...
            s = s.replace("not(0)", "1");
            s = s.replace("not(1)", "0");
            return expressaoRecursiva(s, x - 1, a, b, c);
        }
        return s;
    }
    ...
    public static void main(String[] args) {
        ...
        while (numVariaveis != 0) {
            MyIO.println(expressao(entrada, x));
            entrada = MyIO.readLine();
            numVariaveis = entrada.charAt(0)-48;
        }
    }
