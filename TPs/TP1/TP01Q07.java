...
class TP01Q07 {
    public static String getHtml(String endereco) {
        ...
        try {
            ...
            ips = url.openStream(); // throws an IOException
            buffer = new BufferedReader(new InputStreamReader(ips));
    ...
    static boolean isTable(String s) {
        return (s.charAt(0) == '<' && s.charAt(1) == 't' && s.charAt(2) == 'a' && s.charAt(3) == 'b'
                && s.charAt(4) == 'l' && s.charAt(5) == 'e' && s.charAt(6) == '>');
    }
